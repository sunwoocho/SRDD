...
def main(args):
    ...
    if args.spec == 'ost':
        with open('./misc/class_ost.txt', 'r') as fp:
            all_classes = fp.readlines()
        all_classes = [class_index.strip() for class_index in all_classes]    
    elif args.spec == 'ost_1class':
        with open('./misc/class_ost_1class.txt', 'r') as fp:
            all_classes = fp.readlines()
        all_classes = [class_index.strip() for class_index in all_classes]    
    elif args.spec == 'div2k_1class':
        with open('./misc/class_div2k_1class.txt', 'r') as fp:
            all_classes = fp.readlines()
        all_classes = [class_index.strip() for class_index in all_classes]   
    elif args.spec == 'ost_cluster':
        with open('./misc/class_ost_cluster.txt', 'r') as fp:
            all_classes = fp.readlines()
            print('[**] reading ost cluster ')
        all_classes = [class_index.strip() for class_index in all_classes]   
    elif args.spec == 'ost_cluster5':
        with open('./misc/class_ost_cluster5.txt', 'r') as fp:
            all_classes = fp.readlines()
            print('[**] reading ost cluster5 ')
        all_classes = [class_index.strip() for class_index in all_classes]   
    elif args.spec == 'ost_cluster9':
        with open('./misc/class_ost_cluster9.txt', 'r') as fp:
            all_classes = fp.readlines()
            print('[**] reading ost cluster9 ')
        all_classes = [class_index.strip() for class_index in all_classes]   
    elif args.spec == 'div2k_cluster14':
        with open('./misc/class_div2k_cluster14.txt', 'r') as fp:
            all_classes = fp.readlines()
            print('[**] reading div2k cluster14 ')
        all_classes = [class_index.strip() for class_index in all_classes] 
    elif args.spec == 'Set5':
        with open('./misc/class_set5.txt', 'r') as fp:
            all_classes = fp.readlines()
            print('[**] reading Set5 ')
        all_classes = [class_index.strip() for class_index in all_classes] 
    if args.spec == 'woof':
        ...
        file_list = './misc/class_ost.txt'
    elif args.spec == 'ost_1class':
        file_list = './misc/class_ost_1class.txt'
    elif args.spec == 'div2k_1class':
        file_list = './misc/class_div2k_1class.txt'
    elif args.spec == 'ost_cluster':
        file_list = './misc/class_ost_cluster.txt'
    elif args.spec == 'ost_cluster5':
        file_list = './misc/class_ost_cluster5.txt'
    elif args.spec == 'ost_cluster9':
        file_list = './misc/class_ost_cluster9.txt'                
    elif args.spec == 'div2k_cluster14':
        file_list = './misc/class_div2k_cluster14.txt'
    elif args.spec == 'Set5':
        file_list = './misc/class_set5.txt'
    else:
